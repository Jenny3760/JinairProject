...
<div id="container" class="memberWrap">
	...
	<div class="joinComplete">
		<p class="text">
    	<strong>입력하신 정보와 일치하는<br>아이디 정보는 다음과 같습니다.</strong>	
		</p>
		...
		<div class="btnArea">
			<span>
				<a href="login.jsp" class="btnTypeA sizeL">로그인</a>
			</span>
			<span><a href="<%= contextPath %>/project/booking/index.jsp" class="btnTypeB sizeL correction-target">메인</a></span>
		</div>
	</div>
</div>
