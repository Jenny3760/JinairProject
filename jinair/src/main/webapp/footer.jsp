		...
		<div class="wrap">
			...
			<div class="quickMenu">
				...
				<ul>
					...
					<li><a href="javascript://" onclick="showPopupLayer('https://www.jinair.com/popup/sitemap'); return false" data-click-area="Footer-약관및안내" data-click-name="사이트맵">사이트맵</a></li>
				</ul>
			</div>
			<div class="quickMenu">
				<h2>고객서비스</h2>
...
<script type="text/javascript">
	$(function() {
		$('#btnAddNewsLetter').click(function() {
			...
			showPopupLayer('https://www.jinair.com/popup/newsLetter?emAdr='+emAdr);
			$('#emAdrNewsletter').val('');
		});
	});
